            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".6s">Silakan isi detail pengguna baru pada formulir di bawah
                            ini dengan lengkap dan benar.</p>
                    </div>
                </div>
            </div>
                            ...
                            <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" id="email"
                                        ...
                                        placeholder="Contoh: budi@example.com" value="{{ old('email') }}" required>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="password" name="password" id="password"
                                            ...
                                            placeholder="Masukkan password aman" required>
                                        @error('password')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
