        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h3 class="wow zoomIn" data-wow-delay=".2s">Validasi Data</h3>
                        <h2 class="wow fadeInUp" data-wow-delay=".4s">Hasil Verifikasi Lapangan</h2>
                        <p class="wow fadeInUp" data-wow-delay=".6s">Kelola dan tinjau hasil survei petugas untuk memastikan
            ...
            <style>
                ...
                .action-bar-container {
                    ...
                    border-radius: 20px;
                    border: 1px solid rgba(13, 110, 253, 0.2);
                    /* Warna biru verifikasi */
                    box-shadow: 0 10px 30px rgba(0, 0, 0, 0.05);
                }

                /* Grouping Search dan Select */
                .search-combined-group {
                    display: flex;
                    flex-grow: 1;
                    border-radius: 12px;
                ...
                /* Tombol Search di dalam group */
                .btn-inner-search {
                    background-color: #0d6efd;
                    /* Biru sesuai tema verifikasi */
                    color: white;
                    border: none;
                    padding: 0 20px;
                    transition: 0.3s;
            ...
            <div class="card shadow-sm h-100 border-0 riwayat-card">
                ...
                <div class="riwayat-image-wrapper">
                    ...
                    <div class="badge-score-float">
                        <span class="badge {{ $item->skor >= 70 ? 'bg-success' : 'bg-warning' }} rounded-pill px-3 py-2">
                            Skor: {{ $item->skor }}
                        </span>
                    </div>
                ...
                <div class="card-body d-flex flex-column p-4">
                    {{-- INFO ATAS --}}
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <span class="badge-step text-uppercase" style="background: rgba(13, 110, 253, 0.1); color: #0d6efd; padding: 5px 12px; border-radius: 8px; font-size: 0.75rem; font-weight: 700;">
                            VERIFIKASI
                        </span>
                        <small class="text-muted"><i class="far fa-calendar-alt"></i> {{ \Carbon\Carbon::parse($item->tanggal)->translatedFormat('d/m/Y') }}</small>
                    </div>

                    <h5 class="fw-bold text-dark mb-1 text-truncate" title="{{ $item->pendaftar->warga?->nama }}">
                    ...
                    <div class="mt-auto">
                        <div class="btn-group w-100 gap-2">
                            ...
                            <form action="{{ route('verifikasi.destroy', $item->verifikasi_id) }}" method="POST" class="d-inline flex-grow-1">
                                @csrf @method('DELETE')
