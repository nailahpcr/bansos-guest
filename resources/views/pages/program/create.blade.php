            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".6s">Silakan isi detail program pada formulir di bawah ini
                            ...
                            <form action="{{ route('kelola-program.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="kode" id="kode"
                                        ...
                                        placeholder="Contoh: BLT-DANA-DESA-2025" value="{{ old('kode') }}" required>
                                    @error('kode')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_program" id="nama_program"
                                        ...
                                        placeholder="Contoh: Bantuan Langsung Tunai Dana Desa"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="tahun" id="tahun"
                                            ...
                                            @php
                                                ...
                                                // Contoh: Mulai dari tahun ini sampai 5 tahun ke depan
                                                // Ubah '+ 5' menjadi angka lain jika ingin jangkauan lebih luas
                                            @endphp
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="anggaran" id="anggaran"
                                            ...
                                            placeholder="Contoh: 150000000" value="{{ old('anggaran') }}" required>
                                        @error('anggaran')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" style="height:120px"
                                        name="deskripsi" placeholder="Jelaskan secara singkat tujuan dari program bantuan ini">{{ old('deskripsi') }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
