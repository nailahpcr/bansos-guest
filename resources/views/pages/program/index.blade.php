                    ...
                    <div class="card stat-card shadow-sm">
                        <div class="card-body p-4 position-relative">
                            <div class="d-flex align-items-center position-relative" style="z-index: 2;">
                                ...
                                <div>
                                    <div class="text-uppercase mb-1 fw-bold text-primary"
                                        style="font-size: 0.7rem; letter-spacing: 1px;">Total Program</div>
                    ...
                    <div class="card stat-card shadow-sm">
                        <div class="card-body p-4 position-relative">
                            <div class="d-flex align-items-center position-relative" style="z-index: 2;">
                                ...
                                <div>
                                    <div class="text-uppercase mb-1 fw-bold text-success"
                                        style="font-size: 0.7rem; letter-spacing: 1px;">Filter Tahun Aktif</div>
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeInUp">
                        <div class="card program-card border-0 shadow-sm h-100">
                            ...
                            <div class="program-image-wrapper bg-light">.
                                ...
                                @else
                                    <div
                                        class="d-flex flex-column align-items-center justify-content-center h-100 opacity-25">
                            ...
                            <div class="card-body p-4">
                                ...
                                <h6 class="card-subtitle mb-3 text-muted small"><i class="fas fa-tag me-1"></i>
                                    {{ $program->kode }}</h6>
                                <hr class="my-3 opacity-25">

                                <div class="mb-4">
                                    <p class="mb-1 small text-muted"><i class="fas fa-calendar-alt me-2"></i>Tahun:
                                        {{ $program->tahun }}</p>
                                    <p class="mb-1 small text-muted"><i class="fas fa-money-bill-wave me-2"></i>Rp
                                        {{ number_format($program->anggaran, 0, ',', '.') }}</p>
                                    <p class="mb-0 small text-muted text-truncate"><i
                                            class="fas fa-info-circle me-2"></i>{{ Str::limit($program->deskripsi, 50) }}
                                    </p>
                                </div>

                                <div class="btn-group w-100 gap-2">
                                    <a href="{{ route('kelola-program.show', $program->program_id) }}"
                                    ...
                                    <button type="button" class="btn btn-light-danger flex-fill rounded-3 py-2"
                                        data-bs-toggle="modal" data-bs-target="#delProg{{ $program->program_id }}"><i
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-sm">
                            <div class="modal-content border-0 shadow">
                                <div class="modal-body text-center p-4">
                                    ...
                                    <p class="small text-muted">Yakin ingin menghapus
